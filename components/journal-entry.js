...
class JournalEntry extends HTMLElement {
  ...
  set entry(entry) {
    ...
    if (entry.image) {
      ...
      // CODE GOES HERE vvv
      // this.shadowRoot.querySelector(".entry-image").textContent = entry.image;//cannot do this
    ...
    if (entry.audio) {
      ...
      // this.shadowRoot.querySelector(".entry-content").textContent = entry.content;//cannot do this
